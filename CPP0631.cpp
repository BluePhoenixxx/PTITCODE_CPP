...
public:
    ...
    {
        os << hd.maHoaDon << ' ' << KH[hd.maKhachHang].getTenKhachHang() << ' ' << KH[hd.maKhachHang].getDiaChi() << ' ' << MH[hd.maMatHang].getTenMatHang() << ' ' << MH[hd.maMatHang].getDonViTinh() << ' ' << MH[hd.maMatHang].giaMua << ' ' << MH[hd.maMatHang].giaBan  << ' ' << hd.soLuong << ' ' << MH[hd.maMatHang].giaBan * hd.soLuong << endl;
        return os;
    }
};
